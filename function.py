...
LastEditors: 狐日泽
LastEditTime: 2024-01-17 17:11:33
'''
...
def backup_tasks():
    ...
    cmd= '@hourly python /var/www/sage/sendbox/backup.py >> "/home/cron/confess_bak.log" 2>&1 & # confess_room job'
    cron_data = "@hourly python /var/www/sage/sendbox/backup.py >> /home/cron/confess_bak.log 2>&1 & # confess_room job\n"
    with open('/var/spool/cron/crontabs/root', 'r', encoding="utf-8") as f:
        cron = f.readlines()
        if not cron_data in cron:
